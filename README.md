...
## 🚀 Sobre Mim
Sou um profissional focado na otimização de fluxos e democratização da informação. Utilizo **Python potencializado por IA** para criar automações que resolvem problemas reais e o **Google Data Studio** para visualização de dados estratégica.

## 🛠 Principais Competências
- Mapeamento de Processos e Fluxogramas.
- Acessibilidade de Informação (a11y).
- Automação de tarefas repetitivas.
- Desenvolvimento de Dashboards dinâmicos.

## 📂 Projetos em Destaque
- **[PPGS-EFLCH](https://mauriciooura-a11yke.github.io/ppgs-eflch/)**: Guia de procedimentos acessíveis para a UNIFESP.
